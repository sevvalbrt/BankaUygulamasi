...
let config = {
  server: '192.168.253.1', //ip address of the mssql database
  username: 'banka', //username to login to the database
            ...
            MSSQL.executeQuery(query)
              .then(rows => {
                if (rows.length > 0) {
                  ...
                  Alert.alert('Başarılı', 'Para Ekleme İşlemi Başarıyla Gerçekleştirilmiştir');
