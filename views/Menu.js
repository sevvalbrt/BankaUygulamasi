        ...
        return(
            <View style={styles.container}>
                ...
                <Text  style={styles.buttonText}>{this.props.TC}</Text>
                  <Text  style={styles.buttonText} >YENİ HESAP AÇ</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.button} onPress={()=>this.props.navigation.navigate('havale',{TC:tc})}>
                <Text  style={styles.buttonText}>{this.props.TC}</Text>
